...
/* 0x38 */	cmp_i2rm_b, cmp_i2rm_v, cmp_rm2r_b, cmp_rm2r_v,
...
/* 0x54 */	push_r_v, inv, push_r_v, push_r_v,	// 50 + /r	/r represents num of reg.
...
/* 0xe8 */	call_rel32, inv, inv, jmp_rel8,
